...
const postsSeedData: readonly PostData[] = [
  {
    ...
    body: "Xkexfjht3dACtXZLT58ryQeFz3T9fa8QJBtXTNLgilOnjDlq9Ub5jTh33wtxSTsUJe5dgrdQ3dnhMJjWHIU1uNocOO4iAy/EzsoSDIaqbPe/uwlwOsUO+X+08CGYVguOn+LXudUqgrV6s7Op31gPCabgZMrgo6A3GYMlF7iOz2c=",
